...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐅𝐀𝐒𝐓𝐄𝐑")  
...
os.execute('wget https://raw.githubusercontent.com/ahmedyad200/CLASSIK/master/DRAGON.lua')
send(msg.chat_id_, msg.id_,'🦅 تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and sudo2(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 🦅 اصدار سورس فاستر { s: 6.7}')
end
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'ياسورس' or text == 'سورس مين'  then
local Text =[[
◤━───━❲[𝐅𝐀𝐒𝐓𝐄𝐑](t.me/FA9SH)❳━───━◥
[↝ 𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐬𝐨𝐮𝐫𝐜𝐞 𝐟𝐚𝐬𝐭𝐞𝐫](t.me/FA9SH)
[↝ 𝐬𝐡𝐚𝐝𝐨𝐰](t.me/KB_Shadow)
[↝ 𝐝𝐞𝐯 𝐬𝐞𝐳𝐫](t.me/s_e_z_r0)
[↝ 𝐯𝐚𝐦𝐩𝐢𝐫𝐞](t.me/XxlllllllllllllllllllllllllllxX)
[↝ 𝐜𝐡 𝐟𝐚𝐬𝐭𝐞𝐫](t.me/FA9SH)
◣━───━❲[𝐅𝐀𝐒𝐓𝐄𝐑](t.me/FA9SH)❳━───━◢
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/kanser9/56&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
سيزر مالك السورس لو حابب تتواصل معاه اتبع الزر إلى تحت ↓l
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
database:set(bot_id.."FA9SH:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."FA9SH:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."FA9SH:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."FA9SH:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"🦅تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."FA9SH:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."FA9SH:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس فاستر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐀𝐒𝐓𝐄𝐑', url="t.me/FA9SH"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
رزله⇜هينه⇜هيني⇜رزلي
تخ⇜اصحه⇜تف⇜شخ
رمزيات + ولاد⇜بنات⇜كابلز
بتكره دا⇜بتحبو⇜بتحب دا
استوري⇜ثيم⇜يوتيوب⇜صور
تفعيل غنيلي ⇜غنيلي
بوسي⇜بوسه⇜مصي⇜مصه
